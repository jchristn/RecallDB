  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
        <a className="topbar-discord" href="https://discord.gg/tRAN8HgvK5" target="_blank" rel="noopener noreferrer" title="Discord" aria-label="Discord">
        ...
        <a className="topbar-github" href="https://github.com/jchristn/recalldb" target="_blank" rel="noopener noreferrer" title="GitHub">
          <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
